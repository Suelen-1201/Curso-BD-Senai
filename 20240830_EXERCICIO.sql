--PARA crtl+k+c = a colocar o bloco como comentário, ms sempre deverá 
--selecionar o que deseja colocar como comentário.
...
/*c.Dessas lojas, descubra quantas (e quais) lojas ainda estão ativas.*/--- 294 LOJAS ATIVAS
